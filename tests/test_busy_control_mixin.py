...
MOVED_METHODS = (
    "is_turn_busy",
    "interrupt",
    "_cooperative_disk_mutations_quarantined",
    "_refuse_quarantined_disk_mutation",
    "_kill_owned_command_procs_on_interrupt",
    "_interrupt_owner_tokens",
    "_record_owned_command_orphan_notice",
    "_flush_owned_command_orphan_notice",
    "_flush_stop_boundary_notices",
    "peek_post_interrupt_notices",
