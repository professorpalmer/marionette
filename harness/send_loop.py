...
and action-goal labeling live in ``send_loop_phases``; swarm/implement/parallel/
route_task/memory dispatch lives in ``send_loop_dispatch`` so the kernel stays the
