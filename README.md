...
stdlib-only backend (urllib + sqlite); `puppetmaster-ai==1.22.40` is the one
real dependency the installer puts in the venv.

> Status: v0.9.380, deliberately pre-1.0. Rides puppetmaster-ai==1.22.40. Pi TUI/pilot package (not a worker adapter).
