...
> Status: v0.9.195, deliberately pre-1.0. Agent transcript clicks route to the correct surface (terminal mirror, editor, browser, lightbox, workspace); rides puppetmaster-ai==1.21.13.
