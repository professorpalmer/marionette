...
> Status: v0.9.176, deliberately pre-1.0. Settings auths that can pilot mark Full stack vs Pilot only; Nous/MiniMax/NVIDIA sync into workers; Cursor API key falls back for swarms when no HTTP agentic key is present (rides puppetmaster-ai==1.21.12).
