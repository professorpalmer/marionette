...
> Status: v0.9.200, deliberately pre-1.0. Busy-chrome honesty (R11–R14): awaiting restore, backendPendingSwarms rearm, Investigating sticky cue, holdSwarmAwait latch; rides puppetmaster-ai==1.21.13.
