...
> Status: v0.9.205, deliberately pre-1.0. Claude-style right tool board now supports independently sized, reorderable cards; still rides puppetmaster-ai==1.21.14.
