...
(`v0.6.45`, [all releases](https://github.com/professorpalmer/marionette/releases/latest)):

- macOS (universal, Intel + Apple Silicon): [Marionette-0.6.45-universal.dmg](https://github.com/professorpalmer/marionette/releases/download/v0.6.45/Marionette-0.6.45-universal.dmg)
- Windows: [Marionette-0.6.45-Setup.exe](https://github.com/professorpalmer/marionette/releases/download/v0.6.45/Marionette-0.6.45-Setup.exe)
- Linux: [Marionette-0.6.45.AppImage](https://github.com/professorpalmer/marionette/releases/download/v0.6.45/Marionette-0.6.45.AppImage)
