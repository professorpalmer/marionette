...
> Status: v0.9.96, deliberately pre-1.0. Emergency release recovering legacy update-stream authentication; reliable live transcript containment/replay, vetted privately before any wider release.
