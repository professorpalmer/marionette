...
(`v0.6.47`, [all releases](https://github.com/professorpalmer/marionette/releases/latest)):

- macOS (universal, Intel + Apple Silicon): [Marionette-0.6.47-universal.dmg](https://github.com/professorpalmer/marionette/releases/download/v0.6.47/Marionette-0.6.47-universal.dmg)
- Windows: [Marionette-0.6.47-Setup.exe](https://github.com/professorpalmer/marionette/releases/download/v0.6.47/Marionette-0.6.47-Setup.exe)
- Linux: [Marionette-0.6.47.AppImage](https://github.com/professorpalmer/marionette/releases/download/v0.6.47/Marionette-0.6.47.AppImage)
