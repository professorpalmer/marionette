...
> Status: v0.9.175, deliberately pre-1.0. ChatGPT Codex OAuth drives agentic swarm/implement workers on the same token as the pilot (rides puppetmaster-ai==1.21.11).
