...
stdlib-only backend (urllib + sqlite); `puppetmaster-ai==1.22.30` is the one
real dependency the installer puts in the venv.

> Status: v0.9.340, deliberately pre-1.0. Rides puppetmaster-ai==1.22.30. Pi TUI/pilot package (not a worker adapter).
