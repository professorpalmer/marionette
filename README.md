...
> Status: v0.9.174, deliberately pre-1.0. Audit round-7 security: wiki-connect allowlist + WikiClient SSRF pin + popout http(s) gate; boot-usage RLock; updater orphan-stash recovery (rides puppetmaster-ai==1.21.10).
