...
stdlib-only backend (urllib + sqlite); `puppetmaster-ai==1.22.25` is the one
real dependency the installer puts in the venv.

> Status: v0.9.288, deliberately pre-1.0. Rides puppetmaster-ai==1.22.25. Pi TUI/pilot package (not a worker adapter).
