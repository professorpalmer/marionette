...
> Status: v0.9.180, deliberately pre-1.0. Scratch store fails closed on corruption (quarantine via clear_scratch); `/compact` echoes in the transcript (rides puppetmaster-ai==1.21.13).
